...
To extarct X positions, Y positions and denisty, the returend array has to be split horizontally equally as shown below.
...
a, b = getting_charge_densities_from_CHGCAR('CHGCAR-1',c)
